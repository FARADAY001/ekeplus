		...
		<div class="section-authentication-cover">
            ...
            <form class="row g-3" method="POST" action="{{ route('login') }}">
                ...
                <div class="col-12">
                    ...
                    <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="kone@example.com">
                    @error('email')
                ...
                <div class="col-12">
                    ...
                    <div class="input-group" id="show_hide_password">
                        <input type="password" id="password" name="password" class="form-control border-end-0  @error('password') is-invalid @enderror"  placeholder="Entrer le mot de passe"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
                ...
                <div class="col-12">
                    <div class="text-center ">
                        ...
                        -->
									...
									<div class="login-separater text-center mb-5"> <span> <!-- OU SE CONNECTER AVEC -->  </span>
										<hr>
									</div>
                                    <!--
