            ...
            <div class="card-header">
              ...
              <div class="card-body">
                <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
                    <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #14abef"></i>Vues</span>
                    <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ffc107"></i>Visites</span>
                </div>
              ...
              <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0"></h5>
                    <small class="mb-0"> <!-- <span> <i class="bx bx-up-arrow-alt align-middle"></i> </span>   -->  </small>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
