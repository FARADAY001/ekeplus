...
<div class="page-content">
    ...
    <img src="{{ (!empty($profileData->photo)) ? url('upload/producer_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
    <div class="mt-3">
...
<div class="col-lg-8">
    <div class="card">
        ...
        <form method="POST" action="{{ route('producer.profile.store') }}"  enctype="multipart/form-data">
            @csrf
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                    <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/producer_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                </div>
            </div>
